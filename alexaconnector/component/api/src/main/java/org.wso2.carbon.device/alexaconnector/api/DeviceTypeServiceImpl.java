...
package org.wso2.carbon.device.alexaconnector.api;

import org.wso2.carbon.device.alexaconnector.api.dto.DeviceJSON;
import org.wso2.carbon.device.alexaconnector.api.dto.SensorRecord;
import org.wso2.carbon.device.alexaconnector.api.util.APIUtil;
import org.wso2.carbon.device.alexaconnector.api.util.ZipUtil;
import org.wso2.carbon.device.alexaconnector.api.util.ZipArchive;
...
public class DeviceTypeServiceImpl implements DeviceTypeService {
    ...
    public Response changeStatus(@PathParam("deviceId") String deviceId,
        ...
        try {
            ...
            deviceIdentifiers.add(new DeviceIdentifier(deviceId, "alexaconnector"));
            APIUtil.getDeviceManagementService().addOperation("alexaconnector", commandOp,
                                                              deviceIdentifiers);
