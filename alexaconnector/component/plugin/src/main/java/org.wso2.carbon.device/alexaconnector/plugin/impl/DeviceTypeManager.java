...
package org.wso2.carbon.device.alexaconnector.plugin.impl;
...
import org.wso2.carbon.device.alexaconnector.plugin.impl.feature.DeviceTypeFeatureManager;
...
/**
 * This represents the alexaconnector implementation of DeviceManagerService.
 */
public class DeviceTypeManager implements DeviceManager {
    ...
    public boolean enrollDevice(Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Enrolling a new alexaconnector device : " + device.getDeviceIdentifier());
            }
            ...
            String msg = "Error while enrolling the alexaconnector device : " + device.getDeviceIdentifier();
            log.error(msg, e);
    ...
    public boolean modifyEnrollment(Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Modifying the alexaconnector device enrollment data");
            }
            DeviceTypeDAO.beginTransaction();
            ...
            String msg = "Error while updating the enrollment of the alexaconnector device : " +
    ...
    public boolean disenrollDevice(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Dis-enrolling alexaconnector device : " + deviceId);
            }
            DeviceTypeDAO.beginTransaction();
            ...
            String msg = "Error while removing the alexaconnector device : " + deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return status;
    ...
    public boolean isEnrolled(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Checking the enrollment of alexaconnector device : " + deviceId.getId());
            }
            Device iotDevice =
            ...
            String msg = "Error while checking the enrollment status of alexaconnector device : " +
                    deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
    ...
    public Device getDevice(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Getting the details of alexaconnector device : " + deviceId.getId());
            }
            device = deviceTypeDAO.getDeviceTypeDAO().getDevice(deviceId.getId());
        } catch (DeviceMgtPluginException e) {
            String msg = "Error while fetching the alexaconnector device : " + deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return device;
    ...
    public boolean updateDeviceInfo(DeviceIdentifier deviceIdentifier, Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("updating the details of alexaconnector device : " + deviceIdentifier);
            }
            DeviceTypeDAO.beginTransaction();
            status = deviceTypeDAO.getDeviceTypeDAO().updateDevice(device);
            DeviceTypeDAO.commitTransaction();
            ...
            String msg =
                    "Error while updating the alexaconnector device : " + deviceIdentifier;
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return status;
    ...
    public List<Device> getAllDevices() throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Fetching the details of all alexaconnector devices");
            }
            devices = deviceTypeDAO.getDeviceTypeDAO().getAllDevices();
        } catch (DeviceMgtPluginException e) {
            String msg = "Error while fetching all alexaconnector devices.";
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return devices;
