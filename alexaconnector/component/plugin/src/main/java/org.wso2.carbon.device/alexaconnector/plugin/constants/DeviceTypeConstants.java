...
package org.wso2.carbon.device.alexaconnector.plugin.constants;
...
public class DeviceTypeConstants {
    public final static String DEVICE_TYPE = "alexaconnector";
    public final static String DEVICE_PLUGIN_DEVICE_NAME = "DEVICE_NAME";
    public final static String DEVICE_PLUGIN_DEVICE_ID = "alexaconnector_DEVICE_ID";
    ...
    public final static String SENSOR_TYPE2 = "alexa1";

    //mqtt tranport related constants
    public static final String MQTT_ADAPTER_NAME = "alexa_mqtt";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/alexaconnector/+/alexa";
    ...
    public final static String SENSOR_TYPE1_STREAM_DEFINITION = "org.wso2.iot.devices.alexa";
    public final static String SENSOR_TYPE1_STREAM_DEFINITION_VERSION = "1.0.0";

    public final static String SENSOR_TYPE2_STREAM_DEFINITION = "org.wso2.iot.devices.alexa1";
